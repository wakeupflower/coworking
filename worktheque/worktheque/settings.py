"""
Django settings for worktheque project.
...
SECRET_KEY = 'django-insecure-@1=os)oc0+oyta=2%@=i=obede=34+rwy@n-t@&4_pzjx7^7cz'
...
CSRF_COOKIE_SECURE = True  # Ensure this is True if you're using HTTPS in production
...
WSGI_APPLICATION = 'worktheque.wsgi.application'
...
# Define where Django should look for static files in addition to app-specific static folders
STATICFILES_DIRS = [
